    ...
    >
      ...
      >
        <span className="font-bold">
          Hello, I'm <span className="text-orange-400">Jigyanshu</span>.
        </span>{" "}
      ...
      >
        ...
        <a
          ...
          href="https://in.linkedin.com/in/jigyanshu-thakur"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/jigyanshu-codes"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
